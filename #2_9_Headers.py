...
# у response headers: як правило приходить інформація про те, в якому форматі ця відповідь, які cookies і з яким значенням сервер просить клієнта втановити,
# а також може приходити заголовок location, який відповідає за редірект і вказує на яку саме адресу має відбутись redirect.

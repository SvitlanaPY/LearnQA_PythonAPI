...
# У цю ф-ію прийнято класти логіку, з якої повинні починатись всі тести в класі.
# у всіх змінних, які потім будуть використовуватись в ін. тестових ф-іях треба додавати self.
# self - це спеціальний вказівник, що дозволяє робити змінну полем/реквізитом класу і передавати її значення з однієї змінної в інші.

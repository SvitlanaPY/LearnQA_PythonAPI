...
# Лише у випадку передачі і вірного значення авторизаційного cookie (auth_sid) і вірного значення header-a/заголовка (x-csrf-token), подальші запити будуть вважатись авторизованими.
...
class TestUserAuth:
    ...
    # у функції setup відбувається логування і отримання auth_sid, x-csrf-token, user_id

...
# URL вказує адресу, куди робиться запит, а заголовки - несуть додаткову інформацію про клієнта.
...
# але параметри, які треба передавати з іншими типами запиту і які передаються через тіло запиту, необхідно передавати не через params, а через data.

...
# статус-код 404 (запит на неіснуючий URL чи запити у старому форматі, якого сервер вже не розуміє):
...
# це потрібно для того, щоб клієнт міг закешувати, тобто запам'ятати permanent redirect при 301,
...
# додатковй параметр allow_redirects:
...
# інформація по останньому, підсумковому запитові, буде у змінній response

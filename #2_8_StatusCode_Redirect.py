...
print(first_response.url)   # print(response1.history[0].url)
print(second_response.url)   # print(response1.url)
print(response1.status_code)   # print(second_response.status_code)

...
class TestUserAuth:
    def test_user_auth(self):
        ...
        user_id_from_auth_method = response1.json().get("user_id")   # = response1.json()["user_id"]
    ...
    def test_negative_user_auth(self, condition):
        ...
        # assert "user_id" in response1.json(), "There is no user id in the response1"
        # "user_id" нам не потрібне, бо при подальших перевірках ми не будемо його використовувати

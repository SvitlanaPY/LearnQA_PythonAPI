...
# Першим параметром завжди іде URL, на який ми хочемо передати запит. Оскільки це строка, то вона має бути загорнута в подвійні лапки.
...
# У змінній response якраз буде доступ до всіх деталей відповіді сервера
# і те, що в ній доступно, ми можемо побачити напечатавши ім'я змінної після того, як вона була проініціалізована, поставивши крапку після її назви
...
#  в змінну payload кладемо одну пару "ключ":"значення"
payload = {"name": "USER"}
